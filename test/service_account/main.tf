  ...
  app_roles = [
    {
      ...
      description          = "Data Lake Administrator App Role"
...
module "azure_service_account" {
  source     = "github.com/sim-parables/terraform-azure-service-account.git?ref=5dcf3adf26ed12badcfd43f4b2f87e4d402c0c18"
...
module "azure_application_federated_identity_credential" {
  source     = "github.com/openvers/terraform-azure-service-account.git//modules/identity_federation?ref=5dcf3adf26ed12badcfd43f4b2f87e4d402c0c18"
